...
def register_backend(
    format: str,
    backend: str | type[FigureCanvasBase],
...
class FigureCanvasBase:
    ...
    @_api.classproperty
    def manager_class(self) -> type[FigureManagerBase]: ...

    events: list[str]
    fixed_dpi: float | None
    filetypes: dict[str, str]
    @_api.classproperty
    def supports_blit(self) -> bool: ...

    figure: Figure
    manager: FigureManagerBase | None
    widgetlock: widgets.LockDraw
    mouse_grabber: Axes | None
...
class NavigationToolbar2:
    ...
    def save_figure(self, *args) -> str | object | None: ...
