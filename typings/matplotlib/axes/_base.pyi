...
type _AxisValue = float | int | str | datetime.date | datetime.datetime | np.datetime64
...
class _AxesBase(martist.Artist):
    ...
    def get_xaxis_transform(
        self,
        which: Literal["grid", "tick1", "tick2"] = ...,
    ) -> Transform: ...
    ...
    def set_axes_locator(
        self,
        locator: Callable[[_AxesBase, RendererBase], Bbox],
    ) -> None: ...
    ...
    def set_xlim(
        self,
        left: _AxisValue | tuple[_AxisValue, _AxisValue] | None = ...,
        right: _AxisValue | None = ...,
        *,
        emit: bool = ...,
        auto: bool | None = ...,
        xmin: _AxisValue | None = ...,
        xmax: _AxisValue | None = ...,
    ) -> tuple[float, float]: ...
    ...
    def set_xscale(self, value: str | ScaleBase, **kwargs: Any) -> None: ...
    ...
    def set_yscale(self, value: str | ScaleBase, **kwargs: Any) -> None: ...
