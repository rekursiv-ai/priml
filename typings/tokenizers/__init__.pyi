...
class AddedToken:
    ...
    def __new__(cls, /, content: str | None = ..., **kwargs) -> AddedToken: ...
...
class PreTokenizedString:
    ...
    def get_splits(
        self,
        /,
        offset_referential: Incomplete = ...,
        offset_type: Incomplete = ...,
...
class Tokenizer:
    ...
    def train(self, /, files: Sequence[str], trainer: Trainer | None = ...) -> None: ...
