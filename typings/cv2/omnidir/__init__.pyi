...
def stereoCalibrate(
    ...
    imageSize1: cv2.typing.Size,
    imageSize2: cv2.typing.Size,
    K1: cv2.typing.MatLike,
    xi1: cv2.typing.MatLike,
    D1: cv2.typing.MatLike,
    K2: cv2.typing.MatLike,
    xi2: cv2.typing.MatLike,
    D2: cv2.typing.MatLike,
    flags: int,
    criteria: cv2.typing.TermCriteria,
    rvec: cv2.typing.MatLike | None = ...,
    tvec: cv2.typing.MatLike | None = ...,
    rvecsL: _typing.Sequence[cv2.typing.MatLike] | None = ...,
    tvecsL: _typing.Sequence[cv2.typing.MatLike] | None = ...,
    idx: cv2.typing.MatLike | None = ...,
) -> tuple[
    float,
    _typing.Sequence[cv2.typing.MatLike],
...
def stereoCalibrate(
    ...
    rvec: cv2.UMat | None = ...,
    tvec: cv2.UMat | None = ...,
    rvecsL: _typing.Sequence[cv2.UMat] | None = ...,
    tvecsL: _typing.Sequence[cv2.UMat] | None = ...,
    idx: cv2.UMat | None = ...,
) -> tuple[
    float,
    _typing.Sequence[cv2.UMat],
...
def stereoReconstruct(
    ...
    image1Rec: cv2.typing.MatLike | None = ...,
    image2Rec: cv2.typing.MatLike | None = ...,
    newSize: cv2.typing.Size = ...,
    Knew: cv2.typing.MatLike | None = ...,
    pointCloud: cv2.typing.MatLike | None = ...,
    pointType: int = ...,
) -> tuple[
    cv2.typing.MatLike,
    cv2.typing.MatLike,
...
def stereoReconstruct(
    ...
    numDisparities: int,
    SADWindowSize: int,
    disparity: cv2.UMat | None = ...,
    image1Rec: cv2.UMat | None = ...,
    image2Rec: cv2.UMat | None = ...,
    newSize: cv2.typing.Size = ...,
    Knew: cv2.UMat | None = ...,
    pointCloud: cv2.UMat | None = ...,
    pointType: int = ...,
