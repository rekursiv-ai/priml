...
class PyParams:
    ...
    def cfgInputTensorLayout(
        self,
        layout_map: cv2.typing.map_string_and_string,
    ) -> PyParams: ...
    @_typing.overload
    ...
    def cfgOutputTensorPrecision(
        self,
        precision_map: cv2.typing.map_string_and_int,
    ) -> PyParams: ...
    @_typing.overload
    ...
    def cfgReshape(
        self,
        new_shape_map: cv2.typing.map_string_and_vector_size_t,
    ) -> PyParams: ...
    ...
    def cfgScale(
        self,
        scale_map: cv2.typing.map_string_and_vector_float,
    ) -> PyParams: ...
    @_typing.overload
