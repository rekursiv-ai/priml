...
@_typing.overload
def testOverloadResolution(value: int, point: cv2.typing.Point = ...) -> str: ...  # noqa: PT028 -- Mirrors upstream fixture defaults.
@_typing.overload
...
def testReservedKeywordConversion(
    ...
    lambda_: int = ...,  # noqa: PT028 -- Mirrors upstream fixture defaults.
    from_: int = ...,  # noqa: PT028 -- Mirrors upstream fixture defaults.
) -> str: ...
def testRotatedRect(
    x: float,
    y: float,
