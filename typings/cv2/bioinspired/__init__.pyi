...
class Retina(cv2.Algorithm):
    ...
    def applyFastToneMapping(
        ...
        outputToneMappedImage: cv2.typing.MatLike | None = ...,
    ) -> cv2.typing.MatLike: ...
    @_typing.overload
    def applyFastToneMapping(
        self,
        inputImage: cv2.UMat,
        outputToneMappedImage: cv2.UMat | None = ...,
    ) -> cv2.UMat: ...
    @_typing.overload
    def getParvo(
        self,
        retinaOutput_parvo: cv2.typing.MatLike | None = ...,
    ) -> cv2.typing.MatLike: ...
    @_typing.overload
    ...
    def getMagno(
        self,
        retinaOutput_magno: cv2.typing.MatLike | None = ...,
    ) -> cv2.typing.MatLike: ...
    @_typing.overload
...
class TransientAreasSegmentationModule(cv2.Algorithm):
    ...
    def run(
        self,
        inputToSegment: cv2.typing.MatLike,
        channelIndex: int = ...,
    ) -> None: ...
    @_typing.overload
    def run(self, inputToSegment: cv2.UMat, channelIndex: int = ...) -> None: ...
    @_typing.overload
    def getSegmentationPicture(
        self,
        transientAreas: cv2.typing.MatLike | None = ...,
    ) -> cv2.typing.MatLike: ...
    @_typing.overload
    def getSegmentationPicture(
        self,
        transientAreas: cv2.UMat | None = ...,
    ) -> cv2.UMat: ...
