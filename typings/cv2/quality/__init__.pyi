...
class QualityBRISQUE(QualityBase):
    ...
    def computeFeatures(
        img: cv2.typing.MatLike,
        features: cv2.typing.MatLike | None = ...,
    ) -> cv2.typing.MatLike: ...
    @staticmethod
    @_typing.overload
...
class QualityGMSD(QualityBase):
    ...
    def compute(
        self,
        ref: cv2.typing.MatLike,
        cmp: cv2.typing.MatLike,
        qualityMap: cv2.typing.MatLike | None = ...,
    ...
    def compute(
        ...
        ref: cv2.UMat,
        cmp: cv2.UMat,
        qualityMap: cv2.UMat | None = ...,
    ) -> tuple[cv2.typing.Scalar, cv2.UMat]: ...
    def empty(self) -> bool: ...
    def clear(self) -> None: ...
    @classmethod
    @_typing.overload
...
class QualityMSE(QualityBase):
    ...
    def compute(
        self,
        cmpImgs: _typing.Sequence[cv2.typing.MatLike],
    ) -> tuple[float, float, float, float]: ...
    @_typing.overload
    def compute(
        self,
        cmpImgs: _typing.Sequence[cv2.UMat],
    ) -> tuple[float, float, float, float]: ...
    @_typing.overload
    def compute(
        self,
