...
class Params:
    ...
    def __init__(
        self,
        volumeInitialPoseRot: cv2.typing.Matx33f,
        volumeInitialPoseTransl: cv2.typing.Vec3f,
    ) -> None: ...
    @_typing.overload
    def __init__(self, volumeInitialPose: cv2.typing.Matx44f) -> None: ...
    @_typing.overload
    def setInitialVolumePose(
        self,
        R: cv2.typing.Matx33f,
        t: cv2.typing.Vec3f,
    ) -> None: ...
    @_typing.overload
...
class KinFu:
    ...
    def getCloud(
        ...
        normals: cv2.typing.MatLike | None = ...,
    ) -> tuple[cv2.typing.MatLike, cv2.typing.MatLike]: ...
    @_typing.overload
    def getCloud(
        self,
        points: cv2.UMat | None = ...,
        normals: cv2.UMat | None = ...,
...
def makeVolume(
    ...
    _voxelSize: float,
    _pose: cv2.typing.Matx44f,
    _raycastStepFactor: float,
    _truncDist: float,
    _maxWeight: int,
    _truncateThreshold: float,
    _resolution: cv2.typing.Vec3i,
) -> Volume: ...
