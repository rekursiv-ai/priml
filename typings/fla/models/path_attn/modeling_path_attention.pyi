...
class PaTHAttentionBlock(GradientCheckpointingLayer):
    def __init__(self, config: PaTHAttentionConfig, layer_idx: int) -> None: ...
    def forward(
        self,
...
class PaTHAttentionModel(PaTHAttentionPreTrainedModel):
    def __init__(self, config: PaTHAttentionConfig) -> PaTHAttentionModel: ...
...
class PaTHAttentionForCausalLM(PaTHAttentionPreTrainedModel, FLAGenerationMixin):
    ...
    def get_decoder(self) -> PaTHAttentionModel: ...
