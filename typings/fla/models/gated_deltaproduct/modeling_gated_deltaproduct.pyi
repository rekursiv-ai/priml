...
class GatedDeltaProductBlock(GradientCheckpointingLayer):
    def __init__(self, config: GatedDeltaProductConfig, layer_idx: int) -> None: ...
    def forward(
        self,
...
class GatedDeltaProductModel(GatedDeltaProductPreTrainedModel):
    def __init__(self, config: GatedDeltaProductConfig) -> None: ...
...
class GatedDeltaProductForCausalLM(
    ...
    def get_decoder(self) -> GatedDeltaProductModel: ...
