...
class Detector:
    ...
    def __init__(
        self,
        modalities: _typing.Sequence[Modality],
        T_pyramid: _typing.Sequence[int],
    ) -> None: ...
    @_typing.overload
    def match(
        self,
        sources: _typing.Sequence[cv2.typing.MatLike],
        threshold: float,
        class_ids: _typing.Sequence[str] = ...,
        quantized_images: _typing.Sequence[cv2.typing.MatLike] | None = ...,
        masks: _typing.Sequence[cv2.typing.MatLike] | None = ...,
    ) -> tuple[_typing.Sequence[Match], _typing.Sequence[cv2.typing.MatLike]]: ...
    @_typing.overload
    def match(
        self,
        sources: _typing.Sequence[cv2.typing.MatLike],
        threshold: float,
        class_ids: _typing.Sequence[str] = ...,
        quantized_images: _typing.Sequence[cv2.UMat] | None = ...,
        masks: _typing.Sequence[cv2.typing.MatLike] | None = ...,
    ) -> tuple[_typing.Sequence[Match], _typing.Sequence[cv2.UMat]]: ...
    def addTemplate(
        self,
        sources: _typing.Sequence[cv2.typing.MatLike],
        class_id: str,
        object_mask: cv2.typing.MatLike,
    ) -> tuple[int, cv2.typing.Rect]: ...
    def addSyntheticTemplate(
        self,
        templates: _typing.Sequence[Template],
        class_id: str,
    ) -> int: ...
