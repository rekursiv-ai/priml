...
class ICP:
    ...
    @_typing.overload
    def registerModelToScene(
        self,
        srcPC: cv2.typing.MatLike,
        dstPC: cv2.typing.MatLike,
    ) -> tuple[int, float, cv2.typing.Matx44d]: ...
    @_typing.overload
    def registerModelToScene(
        self,
        srcPC: cv2.typing.MatLike,
        dstPC: cv2.typing.MatLike,
        poses: _typing.Sequence[Pose3D],
    ) -> tuple[int, _typing.Sequence[Pose3D]]: ...
...
class PPF3DDetector:
    ...
    def __init__(
        self,
        relativeSamplingStep: float,
        relativeDistanceStep: float = ...,
        numAngles: float = ...,
    ) -> None: ...
    def trainModel(self, Model: cv2.typing.MatLike) -> None: ...
    def match(
        self,
        scene: cv2.typing.MatLike,
        relativeSceneSampleStep: float = ...,
        relativeSceneDistance: float = ...,
    ) -> _typing.Sequence[Pose3D]: ...

def addNoisePC(pc: cv2.typing.MatLike, scale: float) -> cv2.typing.MatLike: ...
def computeNormalsPC3d(
    PC: cv2.typing.MatLike,
    NumNeighbors: int,
    FlipViewpoint: bool,
    viewpoint: cv2.typing.Vec3f,
    PCNormals: cv2.typing.MatLike | None = ...,
...
def samplePCByQuantization(
    pc: cv2.typing.MatLike,
    xrange: cv2.typing.Vec2f,
    yrange: cv2.typing.Vec2f,
    zrange: cv2.typing.Vec2f,
    sample_step_relative: float,
    weightByCenter: int = ...,
) -> cv2.typing.MatLike: ...
def transformPCPose(
    pc: cv2.typing.MatLike,
    Pose: cv2.typing.Matx44d,
) -> cv2.typing.MatLike: ...
def writePLY(PC: cv2.typing.MatLike, fileName: str | os.PathLike[str]) -> None: ...
def writePLYVisibleNormals(
    PC: cv2.typing.MatLike,
    fileName: str | os.PathLike[str],
) -> None: ...
