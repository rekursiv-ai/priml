...
@_typing.overload
def calcOpticalFlowSF(
    from_: cv2.typing.MatLike,
    to: cv2.typing.MatLike,
    layers: int,
    averaging_block_size: int,
    max_flow: int,
...
def calcOpticalFlowSF(
    ...
    sigma_dist: float,
    sigma_color: float,
    postprocess_window: int,
    sigma_dist_fix: float,
    sigma_color_fix: float,
    occ_thr: float,
    upscale_averaging_radius: int,
    upscale_sigma_dist: float,
    upscale_sigma_color: float,
    speed_up_thr: float,
    flow: cv2.typing.MatLike | None = ...,
) -> cv2.typing.MatLike: ...
@_typing.overload
...
def calcOpticalFlowSparseRLOF(
    ...
    prevPts: cv2.UMat,
    nextPts: cv2.UMat,
    status: cv2.UMat | None = ...,
    err: cv2.UMat | None = ...,
    rlofParam: RLOFOpticalFlowParameter = ...,
    forwardBackwardThreshold: float = ...,
) -> tuple[cv2.UMat, cv2.UMat, cv2.UMat]: ...
@_typing.overload
def calcOpticalFlowSparseToDense(
    from_: cv2.typing.MatLike,
    to: cv2.typing.MatLike,
    flow: cv2.typing.MatLike | None = ...,
    grid_step: int = ...,
