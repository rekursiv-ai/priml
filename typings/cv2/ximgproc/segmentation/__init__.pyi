...
class SelectiveSearchSegmentationStrategy(cv2.Algorithm):
    ...
    def setImage(
        ...
        regions: cv2.typing.MatLike,
        sizes: cv2.typing.MatLike,
        image_id: int = ...,
    ) -> None: ...
    @_typing.overload
    def setImage(
...
class SelectiveSearchSegmentationStrategyMultiple(SelectiveSearchSegmentationStrategy):
    def addStrategy(
        self,
        g: SelectiveSearchSegmentationStrategy,
        weight: float,
    ) -> None: ...
...
class SelectiveSearchSegmentation(cv2.Algorithm):
    ...
    def switchToSelectiveSearchFast(
        self,
        base_k: int = ...,
        inc_k: int = ...,
        sigma: float = ...,
    ) -> None: ...
    def switchToSelectiveSearchQuality(
        self,
        base_k: int = ...,
        inc_k: int = ...,
        sigma: float = ...,
...
def createGraphSegmentation(
    sigma: float = ...,
    k: float = ...,
    min_size: int = ...,
) -> GraphSegmentation: ...
def createSelectiveSearchSegmentation() -> SelectiveSearchSegmentation: ...
def createSelectiveSearchSegmentationStrategyColor() -> (
    SelectiveSearchSegmentationStrategyColor
): ...
def createSelectiveSearchSegmentationStrategyFill() -> (
...
def createSelectiveSearchSegmentationStrategySize() -> (
    SelectiveSearchSegmentationStrategySize
): ...
def createSelectiveSearchSegmentationStrategyTexture() -> (
