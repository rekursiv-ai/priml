...
class Saliency(cv2.Algorithm):
    ...
    def computeSaliency(
        ...
        saliencyMap: cv2.typing.MatLike | None = ...,
    ) -> tuple[bool, cv2.typing.MatLike]: ...
    @_typing.overload
    def computeSaliency(
        self,
        image: cv2.UMat,
        saliencyMap: cv2.UMat | None = ...,
    ) -> tuple[bool, cv2.UMat]: ...

class StaticSaliency(Saliency):
    @_typing.overload
    def computeBinaryMap(
        self,
        _saliencyMap: cv2.typing.MatLike,
        _binaryMap: cv2.typing.MatLike | None = ...,
    ) -> tuple[bool, cv2.typing.MatLike]: ...
    @_typing.overload
    def computeBinaryMap(
        self,
        _saliencyMap: cv2.UMat,
        _binaryMap: cv2.UMat | None = ...,
    ) -> tuple[bool, cv2.UMat]: ...
