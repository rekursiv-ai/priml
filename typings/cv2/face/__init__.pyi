...
class Facemark(cv2.Algorithm):
    ...
    def fit(
        self,
        image: cv2.typing.MatLike,
        faces: cv2.typing.MatLike,
        landmarks: _typing.Sequence[cv2.typing.MatLike] | None = ...,
    ...
    def fit(
        ...
        image: cv2.UMat,
        faces: cv2.UMat,
        landmarks: _typing.Sequence[cv2.UMat] | None = ...,
...
def loadDatasetList(
    imageList: str,
    annotationList: str,
    images: _typing.Sequence[str],
    annotations: _typing.Sequence[str],
) -> bool: ...
@_typing.overload
def loadFacePoints(
...
def loadTrainingData(
    filename: str | os.PathLike[str],
    images: _typing.Sequence[str],
    facePoints: cv2.typing.MatLike | None = ...,
    delim: str = ...,
    offset: float = ...,
) -> tuple[bool, cv2.typing.MatLike]: ...
@_typing.overload
...
@_typing.overload
def loadTrainingData(
    filename: _typing.Sequence[str],
    trainlandmarks: _typing.Sequence[_typing.Sequence[cv2.typing.Point2f]],
    trainimages: _typing.Sequence[str],
) -> bool: ...
