...
class DisparityFilter(cv2.Algorithm):
    ...
    def filter(
        self,
        disparity_map_left: cv2.typing.MatLike,
        left_view: cv2.typing.MatLike,
        filtered_disparity_map: cv2.typing.MatLike | None = ...,
        disparity_map_right: cv2.typing.MatLike | None = ...,
        ROI: cv2.typing.Rect = ...,
        right_view: cv2.typing.MatLike | None = ...,
    ) -> cv2.typing.MatLike: ...
    @_typing.overload
    def filter(
        self,
        disparity_map_left: cv2.UMat,
        left_view: cv2.UMat,
        filtered_disparity_map: cv2.UMat | None = ...,
        disparity_map_right: cv2.UMat | None = ...,
        ROI: cv2.typing.Rect = ...,
        right_view: cv2.UMat | None = ...,
    ) -> cv2.UMat: ...
...
class EdgeDrawing(cv2.Algorithm):
    ...
    def detectEllipses(
        self,
        ellipses: cv2.typing.MatLike | None = ...,
    ) -> cv2.typing.MatLike: ...
    @_typing.overload
...
class EdgeBoxes(cv2.Algorithm):
    ...
    def getBoundingBoxes(
        self,
        edge_map: cv2.typing.MatLike,
        orientation_map: cv2.typing.MatLike,
        scores: cv2.typing.MatLike | None = ...,
    ) -> tuple[_typing.Sequence[cv2.typing.Rect], cv2.typing.MatLike]: ...
    @_typing.overload
    def getBoundingBoxes(
        self,
        edge_map: cv2.UMat,
        orientation_map: cv2.UMat,
        scores: cv2.UMat | None = ...,
    ) -> tuple[_typing.Sequence[cv2.typing.Rect], cv2.UMat]: ...
...
class ContourFitting(cv2.Algorithm):
    ...
    def estimateTransformation(
        ...
        alphaPhiST: cv2.typing.MatLike | None = ...,
        fdContour: bool = ...,
    ...
    def estimateTransformation(
        ...
        src: cv2.UMat,
        dst: cv2.UMat,
        alphaPhiST: cv2.UMat | None = ...,
        fdContour: bool = ...,
    ) -> tuple[cv2.UMat, float]: ...
...
class SuperpixelLSC(cv2.Algorithm):
    ...
    def getLabels(
        self,
        labels_out: cv2.typing.MatLike | None = ...,
    ) -> cv2.typing.MatLike: ...
    @_typing.overload
...
class SparseMatchInterpolator(cv2.Algorithm):
    ...
    def interpolate(
        self,
        from_image: cv2.typing.MatLike,
        from_points: cv2.typing.MatLike,
        to_image: cv2.typing.MatLike,
        to_points: cv2.typing.MatLike,
        dense_flow: cv2.typing.MatLike | None = ...,
    ) -> cv2.typing.MatLike: ...
    @_typing.overload
    def interpolate(
        self,
        from_image: cv2.UMat,
        from_points: cv2.UMat,
        to_image: cv2.UMat,
        to_points: cv2.UMat,
        dense_flow: cv2.UMat | None = ...,
    ) -> cv2.UMat: ...
...
class RICInterpolator(SparseMatchInterpolator):
    ...
    def setUseVariationalRefinement(
        self,
...
class StructuredEdgeDetection(cv2.Algorithm):
    ...
    def edgesNms(
        self,
        edge_image: cv2.typing.MatLike,
        orientation_image: cv2.typing.MatLike,
        dst: cv2.typing.MatLike | None = ...,
        r: int = ...,
        s: int = ...,
        m: float = ...,
...
@_typing.overload
def GradientDericheX(
    op: cv2.typing.MatLike,
    alpha: float,
    omega: float,
    dst: cv2.typing.MatLike | None = ...,
) -> cv2.typing.MatLike: ...
...
@_typing.overload
def HoughPoint2Line(
    houghPoint: cv2.typing.Point,
    srcImgInfo: cv2.typing.MatLike,
    angleRange: int = ...,
    makeSkew: int = ...,
    rules: int = ...,
) -> cv2.typing.Vec4i: ...
...
@_typing.overload
def PeiLinNormalization(
    I: cv2.typing.MatLike,
...
def colorMatchTemplate(
    img: cv2.UMat,
    templ: cv2.UMat,
    result: cv2.UMat | None = ...,
) -> cv2.UMat: ...
@_typing.overload
def computeBadPixelPercent(
    GT: cv2.typing.MatLike,
    src: cv2.typing.MatLike,
    ROI: cv2.typing.Rect,
    thresh: int = ...,
) -> float: ...
...
@_typing.overload
def createQuaternionImage(
    img: cv2.typing.MatLike,
    qimg: cv2.typing.MatLike | None = ...,
) -> cv2.typing.MatLike: ...
@_typing.overload
...
def createStructuredEdgeDetection(
    model: str,
    howToGetFeatures: RFFeatureGetter = ...,
) -> StructuredEdgeDetection: ...
@_typing.overload
def createSuperpixelLSC(
    image: cv2.typing.MatLike,
    region_size: int = ...,
    ratio: float = ...,
) -> SuperpixelLSC: ...
...
def findEllipses(
    image: cv2.UMat,
    ellipses: cv2.UMat | None = ...,
    scoreThreshold: float = ...,
    reliabilityThreshold: float = ...,
    centerDistanceThreshold: float = ...,
) -> cv2.UMat: ...
@_typing.overload
def fourierDescriptor(
    src: cv2.typing.MatLike,
    dst: cv2.typing.MatLike | None = ...,
    nbElt: int = ...,
    nbFD: int = ...,
...
def niBlackThreshold(
    _src: cv2.typing.MatLike,
    maxValue: float,
    type: int,
    blockSize: int,
    k: float,
    _dst: cv2.typing.MatLike | None = ...,
...
@_typing.overload
def qconj(
    qimg: cv2.typing.MatLike,
    qcimg: cv2.typing.MatLike | None = ...,
) -> cv2.typing.MatLike: ...
@_typing.overload
