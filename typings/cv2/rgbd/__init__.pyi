...
class RgbdPlane(cv2.Algorithm):
    ...
    def create(
        ...
        min_size: int,
        threshold: float,
        sensor_error_a: float = ...,
        sensor_error_b: float = ...,
        sensor_error_c: float = ...,
    ) -> RgbdPlane: ...
    @_typing.overload
    def apply(
        self,
        points3d: cv2.typing.MatLike,
        normals: cv2.typing.MatLike,
        mask: cv2.typing.MatLike | None = ...,
        plane_coefficients: cv2.typing.MatLike | None = ...,
    ...
    def apply(
        ...
        normals: cv2.UMat,
        mask: cv2.UMat | None = ...,
        plane_coefficients: cv2.UMat | None = ...,
...
class Odometry(cv2.Algorithm):
    ...
    def compute(
        self,
        srcImage: cv2.typing.MatLike,
        srcDepth: cv2.typing.MatLike,
        srcMask: cv2.typing.MatLike,
        dstImage: cv2.typing.MatLike,
        dstDepth: cv2.typing.MatLike,
        dstMask: cv2.typing.MatLike,
        Rt: cv2.typing.MatLike | None = ...,
        initRt: cv2.typing.MatLike | None = ...,
...
class RgbdOdometry(Odometry):
    ...
    def create(
        ...
        maxDepth: float = ...,
        maxDepthDiff: float = ...,
        iterCounts: _typing.Sequence[int] = ...,
        minGradientMagnitudes: _typing.Sequence[float] = ...,
        maxPointsPart: float = ...,
        transformType: int = ...,
    ) -> RgbdOdometry: ...
    def prepareFrameCache(
...
@_typing.overload
def depthTo3d(
    depth: cv2.typing.MatLike,
    K: cv2.typing.MatLike,
    points3d: cv2.typing.MatLike | None = ...,
    mask: cv2.typing.MatLike | None = ...,
) -> cv2.typing.MatLike: ...
@_typing.overload
def depthTo3d(
    depth: cv2.UMat,
    K: cv2.UMat,
    points3d: cv2.UMat | None = ...,
    mask: cv2.UMat | None = ...,
) -> cv2.UMat: ...
@_typing.overload
def depthTo3dSparse(
    depth: cv2.typing.MatLike,
    in_K: cv2.typing.MatLike,
    in_points: cv2.typing.MatLike,
    points3d: cv2.typing.MatLike | None = ...,
) -> cv2.typing.MatLike: ...
@_typing.overload
def depthTo3dSparse(
...
@_typing.overload
def registerDepth(
    unregisteredCameraMatrix: cv2.typing.MatLike,
    registeredCameraMatrix: cv2.typing.MatLike,
    registeredDistCoeffs: cv2.typing.MatLike,
    Rt: cv2.typing.MatLike,
    unregisteredDepth: cv2.typing.MatLike,
    outputImagePlaneSize: cv2.typing.Size,
    registeredDepth: cv2.typing.MatLike | None = ...,
    depthDilation: bool = ...,
) -> cv2.typing.MatLike: ...
@_typing.overload
def registerDepth(
    unregisteredCameraMatrix: cv2.UMat,
    registeredCameraMatrix: cv2.UMat,
    registeredDistCoeffs: cv2.UMat,
    Rt: cv2.UMat,
    unregisteredDepth: cv2.UMat,
    outputImagePlaneSize: cv2.typing.Size,
    registeredDepth: cv2.UMat | None = ...,
    depthDilation: bool = ...,
) -> cv2.UMat: ...
@_typing.overload
def rescaleDepth(
    in_: cv2.typing.MatLike,
    depth: int,
...
def warpFrame(
    ...
    Rt: cv2.typing.MatLike,
    cameraMatrix: cv2.typing.MatLike,
    distCoeff: cv2.typing.MatLike,
    warpedImage: cv2.typing.MatLike | None = ...,
    warpedDepth: cv2.typing.MatLike | None = ...,
    warpedMask: cv2.typing.MatLike | None = ...,
...
def warpFrame(
    ...
    cameraMatrix: cv2.typing.MatLike,
    distCoeff: cv2.typing.MatLike,
    warpedImage: cv2.UMat | None = ...,
    warpedDepth: cv2.UMat | None = ...,
    warpedMask: cv2.UMat | None = ...,
