...
class Feature2D(Algorithm):
    ...
    ) -> tuple[_typing.Sequence[KeyPoint], cv2.typing.MatLike | None]: ...
    @_typing.overload
    def detectAndCompute(
        self,
        image: UMat,
...
class AffineFeature(Feature2D):
    ...
    def setViewParams(
        self,
        tilts: _typing.Sequence[float],
        rolls: _typing.Sequence[float],
    ) -> None: ...
    def getViewParams(
        self,
        tilts: _typing.Sequence[float],
...
class TrackerDaSiamRPN(Tracker):
    ...
    def create(
        cls,
        siam_rpn: cv2.dnn.Net,
        kernel_cls1: cv2.dnn.Net,
        kernel_r1: cv2.dnn.Net,
    ) -> TrackerDaSiamRPN: ...
...
@_typing.overload
def Mahalanobis(
    v1: cv2.typing.MatLike,
    v2: cv2.typing.MatLike,
    icovar: cv2.typing.MatLike,
) -> float: ...
@_typing.overload
...
@_typing.overload
def compareHist(
    H1: cv2.typing.MatLike,
    H2: cv2.typing.MatLike,
    method: int,
) -> float: ...
@_typing.overload
...
def estimateAffine2D(
    ...
    confidence: float = ...,
    refineIters: int = ...,
) -> tuple[cv2.typing.MatLike | None, cv2.typing.MatLike]: ...
@_typing.overload
def estimateAffine2D(
    from_: UMat,
    to: UMat,
    ...
    confidence: float = ...,
    refineIters: int = ...,
) -> tuple[cv2.typing.MatLike | None, UMat]: ...
@_typing.overload
def estimateAffine2D(
...
def imencode(
    ...
    img: cv2.typing.MatLike,
    params: _typing.Sequence[int] = ...,
) -> tuple[bool, np.ndarray[_typing.Any, np.dtype[np.uint8]]]: ...
@_typing.overload
def imencode(
    ext: str,
    img: UMat,
...
def minEnclosingConvexPolygon(
    points: cv2.typing.MatLike,
    k: int,
    polygon: cv2.typing.MatLike | None = ...,
) -> tuple[float, cv2.typing.MatLike]: ...
@_typing.overload
def minEnclosingConvexPolygon(
    points: UMat,
...
def randu(
    dst: cv2.typing.MatLike,
    low: cv2.typing.MatLike,
    high: cv2.typing.MatLike,
) -> cv2.typing.MatLike: ...
@_typing.overload
...
@_typing.overload
def sampsonDistance(
    pt1: cv2.typing.MatLike,
    pt2: cv2.typing.MatLike,
    F: cv2.typing.MatLike,
) -> float: ...
@_typing.overload
...
def dnn_registerLayer(
    layerTypeName: str,
    layerClass: type[cv2.dnn.LayerProtocol],
) -> None: ...
