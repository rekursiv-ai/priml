...
class OCRHMMDecoder(BaseOCR):
    ...
    def create(
        cls,
        classifier: OCRHMMDecoder.ClassifierCallback,
        vocabulary: str,
        transition_probabilities_table: cv2.typing.MatLike,
        emission_probabilities_table: cv2.typing.MatLike,
        mode: int = ...,
    ) -> OCRHMMDecoder: ...
    @classmethod
    @_typing.overload
    def create(
        ...
        classifier: OCRHMMDecoder.ClassifierCallback,
        vocabulary: str,
        transition_probabilities_table: cv2.UMat,
        emission_probabilities_table: cv2.UMat,
        mode: int = ...,
    ) -> OCRHMMDecoder: ...
    @classmethod
    @_typing.overload
...
class OCRBeamSearchDecoder(BaseOCR):
    ...
    def create(
        cls,
        classifier: OCRBeamSearchDecoder.ClassifierCallback,
        vocabulary: str,
        transition_probabilities_table: cv2.typing.MatLike,
        emission_probabilities_table: cv2.typing.MatLike,
        mode: decoder_mode = ...,
...
class TextDetectorCNN(TextDetector):
    ...
    def create(
        cls,
        modelArchFilename: str,
        modelWeightsFilename: str,
    ) -> TextDetectorCNN: ...

@_typing.overload
def computeNMChannels(
    _src: cv2.typing.MatLike,
    _channels: _typing.Sequence[cv2.typing.MatLike] | None = ...,
    _mode: int = ...,
) -> _typing.Sequence[cv2.typing.MatLike]: ...
@_typing.overload
def computeNMChannels(
    _src: cv2.UMat,
    _channels: _typing.Sequence[cv2.UMat] | None = ...,
    _mode: int = ...,
) -> _typing.Sequence[cv2.UMat]: ...
@_typing.overload
def createERFilterNM1(
    cb: ERFilter.Callback,
    thresholdDelta: int = ...,
    minArea: float = ...,
    maxArea: float = ...,
...
def createOCRHMMTransitionsTable(
    vocabulary: str,
    lexicon: _typing.Sequence[str],
) -> cv2.typing.MatLike: ...
@_typing.overload
def detectRegions(
    image: cv2.typing.MatLike,
...
def detectTextSWT(
    ...
    dark_on_light: bool,
    draw: cv2.typing.MatLike | None = ...,
    chainBBs: cv2.typing.MatLike | None = ...,
) -> tuple[
    _typing.Sequence[cv2.typing.Rect],
    cv2.typing.MatLike,
    cv2.typing.MatLike,
...
def detectTextSWT(
    ...
    dark_on_light: bool,
    draw: cv2.UMat | None = ...,
    chainBBs: cv2.UMat | None = ...,
) -> tuple[_typing.Sequence[cv2.typing.Rect], cv2.UMat, cv2.UMat]: ...
@_typing.overload
def erGrouping(
    image: cv2.typing.MatLike,
    channel: cv2.typing.MatLike,
    regions: _typing.Sequence[_typing.Sequence[cv2.typing.Point]],
    method: int = ...,
    filename: str | os.PathLike[str] = ...,
    minProbablity: float = ...,
) -> _typing.Sequence[cv2.typing.Rect]: ...
...
def loadOCRBeamSearchClassifierCNN(
    filename: str | os.PathLike[str],
) -> OCRBeamSearchDecoder.ClassifierCallback: ...
def loadOCRHMMClassifier(
    filename: str | os.PathLike[str],
    classifier: int,
) -> OCRHMMDecoder.ClassifierCallback: ...
def loadOCRHMMClassifierCNN(
    filename: str | os.PathLike[str],
) -> OCRHMMDecoder.ClassifierCallback: ...
def loadOCRHMMClassifierNM(
    filename: str | os.PathLike[str],
) -> OCRHMMDecoder.ClassifierCallback: ...
