...
class ThetaTick(maxis.XTick):
    def __init__(self, axes: PolarAxes, *args, **kwargs: Any) -> None: ...
...
class PolarAxes(Axes):
    ...
    def set_rscale(self, *args, **kwargs: Any) -> None: ...
    def set_rticks(self, *args, **kwargs: Any) -> None: ...
    def set_thetagrids(
        self,
        angles: ArrayLike,
