...
class ExposureCompensator:
    ...
    def getMatGains(
        self,
        arg1: _typing.Sequence[cv2.typing.MatLike] | None = ...,
...
class NoExposureCompensator(ExposureCompensator):
    ...
    def getMatGains(
        self,
        umv: _typing.Sequence[cv2.typing.MatLike] | None = ...,
    ) -> _typing.Sequence[cv2.typing.MatLike]: ...
...
class MatchesInfo:
    ...
    inliers_mask: np.ndarray[_typing.Any, np.dtype[np.uint8]]
    num_inliers: int
    H: cv2.typing.MatLike
    confidence: float
    def getMatches(self) -> _typing.Sequence[cv2.DMatch]: ...
    def getInliers(self) -> np.ndarray[_typing.Any, np.dtype[np.uint8]]: ...
...
def calibrateRotatingCamera(
    Hs: _typing.Sequence[cv2.typing.MatLike],
    K: cv2.typing.MatLike | None = ...,
...
def waveCorrect(
    rmats: _typing.Sequence[cv2.typing.MatLike],
