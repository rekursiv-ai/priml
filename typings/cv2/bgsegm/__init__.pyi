...
class SyntheticSequenceGenerator(cv2.Algorithm):
    ...
    def getNextFrame(
        ...
        gtMask: cv2.typing.MatLike | None = ...,
    ) -> tuple[cv2.typing.MatLike, cv2.typing.MatLike]: ...
    @_typing.overload
    def getNextFrame(
        self,
        frame: cv2.UMat | None = ...,
        gtMask: cv2.UMat | None = ...,
    ) -> tuple[cv2.UMat, cv2.UMat]: ...

def createBackgroundSubtractorCNT(
...
@_typing.overload
def createSyntheticSequenceGenerator(
    background: cv2.typing.MatLike,
    object: cv2.typing.MatLike,
    amplitude: float = ...,
    wavelength: float = ...,
