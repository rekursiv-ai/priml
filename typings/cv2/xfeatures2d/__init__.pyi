...
class FREAK(cv2.Feature2D):
    ...
    def create(
        ...
        patternScale: float = ...,
        nOctaves: int = ...,
        selectedPairs: _typing.Sequence[int] = ...,
    ) -> FREAK: ...
...
class PCTSignatures(cv2.Algorithm):
    ...
    def create(
        cls,
        initSamplingPoints: _typing.Sequence[cv2.typing.Point2f],
        initSeedCount: int,
    ) -> PCTSignatures: ...
    @classmethod
    @_typing.overload
    def create(
        cls,
        initSamplingPoints: _typing.Sequence[cv2.typing.Point2f],
        initClusterSeedIndexes: _typing.Sequence[int],
    ) -> PCTSignatures: ...
    @_typing.overload
    def computeSignature(
        self,
        image: cv2.typing.MatLike,
        signature: cv2.typing.MatLike | None = ...,
    ) -> cv2.typing.MatLike: ...
    @_typing.overload
    def computeSignature(
        self,
        image: cv2.UMat,
        signature: cv2.UMat | None = ...,
    ) -> cv2.UMat: ...
    def computeSignatures(
        self,
        images: _typing.Sequence[cv2.typing.MatLike],
        signatures: _typing.Sequence[cv2.typing.MatLike],
    ) -> None: ...
    @staticmethod
    @_typing.overload
    def drawSignature(
        source: cv2.typing.MatLike,
        signature: cv2.typing.MatLike,
    ...
    @staticmethod
    def generateInitPoints(
        initPoints: _typing.Sequence[cv2.typing.Point2f],
        count: int,
        pointDistribution: int,
    ) -> None: ...
    ...
    def setSamplingPoints(
        self,
        samplingPoints: _typing.Sequence[cv2.typing.Point2f],
    ) -> None: ...
...
class PCTSignaturesSQFD(cv2.Algorithm):
    ...
    @_typing.overload
    def computeQuadraticFormDistance(
        self,
        _signature0: cv2.typing.MatLike,
        _signature1: cv2.typing.MatLike,
    ) -> float: ...
    @_typing.overload
    def computeQuadraticFormDistance(
        self,
        _signature0: cv2.UMat,
        _signature1: cv2.UMat,
    ) -> float: ...
    def computeQuadraticFormDistances(
        self,
        sourceSignature: cv2.typing.MatLike,
        imageSignatures: _typing.Sequence[cv2.typing.MatLike],
        distances: _typing.Sequence[float],
    ) -> None: ...
...
def matchGMS(
    size1: cv2.typing.Size,
    size2: cv2.typing.Size,
    keypoints1: _typing.Sequence[cv2.KeyPoint],
    keypoints2: _typing.Sequence[cv2.KeyPoint],
...
def matchLOGOS(
    keypoints1: _typing.Sequence[cv2.KeyPoint],
    keypoints2: _typing.Sequence[cv2.KeyPoint],
    nn1: _typing.Sequence[int],
    nn2: _typing.Sequence[int],
) -> _typing.Sequence[cv2.DMatch]: ...
