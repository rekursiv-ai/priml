...
class Unigram(Model):
    def __new__(
        cls,
        /,
        vocab: Sequence[tuple[str, float]] | None = ...,
        unk_id: int | None = ...,
        byte_fallback: bool | None = ...,
        alpha: float | None = ...,
        nbest_size: int | None = ...,
    ) -> Unigram: ...
    @property
...
class WordLevel(Model):
    ...
    @classmethod
    def from_file(cls, /, vocab: str, unk_token: str | None = ...) -> WordLevel: ...
    @staticmethod
