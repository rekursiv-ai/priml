...
class BinaryDescriptor(cv2.Algorithm):
    ...
    ) -> _typing.Sequence[KeyLine]: ...
    def compute(
        self,
        image: cv2.typing.MatLike,
        keylines: _typing.Sequence[KeyLine],
        descriptors: cv2.typing.MatLike | None = ...,
        returnFloatDescr: bool = ...,
    ) -> tuple[_typing.Sequence[KeyLine], cv2.typing.MatLike]: ...
...
class LSDDetector(cv2.Algorithm):
    ...
    def detect(
        ...
        keylines: _typing.Sequence[_typing.Sequence[KeyLine]],
        scale: int,
        numOctaves: int,
...
class BinaryDescriptorMatcher(cv2.Algorithm):
    ...
    def knnMatch(
        ...
        mask: cv2.typing.MatLike | None = ...,
        compactResult: bool = ...,
    ) -> _typing.Sequence[_typing.Sequence[cv2.DMatch]]: ...
    def knnMatchQuery(
        self,
        queryDescriptors: cv2.typing.MatLike,
        matches: _typing.Sequence[_typing.Sequence[cv2.DMatch]],
        k: int,
        masks: _typing.Sequence[cv2.typing.MatLike] | None = ...,
        compactResult: bool = ...,
    ) -> None: ...
...
def drawKeylines(
    image: cv2.typing.MatLike,
    keylines: _typing.Sequence[KeyLine],
    outImage: cv2.typing.MatLike | None = ...,
    color: cv2.typing.Scalar = ...,
    flags: int = ...,
) -> cv2.typing.MatLike: ...
def drawLineMatches(
    img1: cv2.typing.MatLike,
    keylines1: _typing.Sequence[KeyLine],
    img2: cv2.typing.MatLike,
    keylines2: _typing.Sequence[KeyLine],
    matches1to2: _typing.Sequence[cv2.DMatch],
    outImg: cv2.typing.MatLike | None = ...,
    matchColor: cv2.typing.Scalar = ...,
    singleLineColor: cv2.typing.Scalar = ...,
